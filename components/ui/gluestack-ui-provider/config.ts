...
export const config = {
  light: vars({
    '--color-primary-0': '230 255 245',
    '--color-primary-50': '200 245 230',
    '--color-primary-100': '150 225 200',
    '--color-primary-200': '100 200 165',
    '--color-primary-300': '0 179 126',
    '--color-primary-400': '0 135 95',
    '--color-primary-500': '0 115 85',
    '--color-primary-600': '0 100 75',
    '--color-primary-700': '0 80 60',
    '--color-primary-800': '0 60 45',
    '--color-primary-900': '0 40 30',
    '--color-primary-950': '0 20 15',
    ...
    '--color-typography-50': '240 240 245',
    '--color-typography-100': '225 225 230',
    '--color-typography-200': '196 196 204',
    '--color-typography-300': '165 165 175',
    '--color-typography-400': '124 124 138',
    '--color-typography-500': '80 80 89',
    '--color-typography-600': '50 50 56',
    '--color-typography-700': '41 41 46',
    '--color-typography-800': '32 32 36',
    '--color-typography-900': '25 25 30',
    '--color-typography-950': '15 15 20',
    ...
    /* Background */
    '--color-background-0': '240 240 245',
    '--color-background-50': '235 235 240',
    '--color-background-100': '225 225 230',
    '--color-background-200': '196 196 204',
    '--color-background-300': '165 165 175',
    '--color-background-400': '124 124 138',
    '--color-background-500': '80 80 89',
    '--color-background-600': '50 50 56',
    '--color-background-700': '41 41 46',
    '--color-background-800': '32 32 36',
    '--color-background-900': '25 25 30',
    '--color-background-950': '15 15 20',
